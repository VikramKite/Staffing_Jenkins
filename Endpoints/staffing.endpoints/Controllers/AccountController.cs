...
namespace staffing.endpoints.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return View(data.Count > 0 ? data : null);
        }
                ...
                case SignInStatus.Success:
                    {
                        ...
                        Session["RoleID"] = user.user_role_id;
        ...
        public async Task<ActionResult> RegisterUser(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.email, Email = model.email, first_name = model.first_name, last_name = model.last_name, user_role_id = model.user_role_id };
